            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                          <img src="resources/icones/doctor2.png">  Modification médecin
                        </h1>
                        <ol class="breadcrumb">
                            <li>
                            ...
                            <li class="active">
                                <i class="fa fa-table"></i> Modification médecin
                            </li>
                        </ol>
                    </div>
                </div>
				...
				<div class="col-sm-4">
	                ...
	                <c:if test="${medecin.id==0}">
						<c:set var="method" value="insertMedecin.html"></c:set>
					     </c:if>
					<c:if test="${medecin.id!=0}">
						<c:set var="method" value="updateMedecin.html"></c:set>
					     </c:if>
	                           -->  
 							<f:form action="updateMedecin.html" methode="post"  modelAttribute="medecin" >
 							<fieldset>
 							<input type="hidden" name="id" value="${medecin.id}" >
                            <div class="panel-body">
                            <div class="form-group input-group">
                                <span class="input-group-addon">nom</span>
                                <input type="text" name="nom" value="${medecin.nom}" class="form-control" placeholder="Username" required>
                            </div>
							<div class="form-group input-group">
                                <span class="input-group-addon">mot de passe</span>
                                <input type="text" name="password" value="${medecin.password}" class="form-control" placeholder="password" required>
							</div>
							<div class="form-group input-group">
                                <span class="input-group-addon">cin</span>
                                <input type="text" name="cin" value="${medecin.cin}" class="form-control" placeholder="Carte d'identité" required>
                            </div>
							<div class="form-group input-group">
                                <span class="input-group-addon">specialite</span>
                                <input type="text" name="specialite" value="${medecin.specialite}" class="form-control" placeholder="specialite" required>
                            </div>
