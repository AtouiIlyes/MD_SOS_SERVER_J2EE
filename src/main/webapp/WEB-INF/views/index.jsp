    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <ul class="nav navbar-right top-nav">
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i><c:out value="${agent.email_agent}"></c:out><b class="caret"></b></a>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                           <big><strong> MD-sos </strong></big><small>Mute and Deaf emergency</small>
                        </h1>
                        <ol class="breadcrumb">
                            <img src="resources/icones/f.png" >
                        </ol>
                    </div>
                </div>
                <!-- /.row -->
