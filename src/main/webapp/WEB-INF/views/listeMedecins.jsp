...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <ul class="nav navbar-right top-nav">
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i> <c:out value="${agent.email_agent}" /> Ilyes<b class="caret"></b></a>
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                          <img src="resources/icones/doctor2.png">  Liste des Médecins 
                        </h1>
                        <ol class="breadcrumb">
                            <li>
                            ...
                            <li class="active">
                                <i class="fa fa-table"></i> Liste des médecins
                            </li>
                        </ol>
                    </div>
               ...
               <div>
            <!-- /.container-fluid -->
				 <a href="ModifierMedecin.html"><button class="btn btn-success" type="submit">Ajouter</button> </a><br> <br>
				</div>
                                ...
                                <tbody>
                                 <c:forEach items="${medecins}" var="medecin">
                                    <tr>
                                        ...
                                        <td>
										<button class="btn btn-xs btn-danger" type="button"  onclick="javascript:deleteMedecin (${medecin.id})">Supprimer</button>
										<button class="btn btn-xs btn-info" type="button" onclick="window.location.href='editMedecin.html?id=${medecin.id}'">Modifier</button>
										</td>
        ...
        <!-- /#page-wrapper -->
        <footer>
                <p>&copy; Projet Fin D'etude 2015  IsIma</p>
            </footer>
    ...
    function deleteMedecin(id){
    	if (confirm("Etes vous sûr de vouloir supprimer cet medecin?")){
    		window.location.href='deleteMedecin.html?id='+id;
    	}
    }
    </script>
