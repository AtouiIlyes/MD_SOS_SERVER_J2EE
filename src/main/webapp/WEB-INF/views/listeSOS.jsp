                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                           <img src="resources/icones/emergency2.png"> Liste des demandes d'urgences
                        </h1>
                        <ol class="breadcrumb">
                            <li>
                            ...
                            <li class="active">
                                <i class="fa fa-table"></i> Liste des demandes d'urgences
                            </li>
                        </ol>
                    </div>
                </div>
                                ...
                                <tbody>
                                 ...
                                 <c:forEach items="${declarations}" var="declaration">
                                    <tr>
                                        ...
                                        <td>${declaration.danger}</td>
                                        <td>${declaration.latitude} <br> ${declaration.longitude}</td>
                                        <td>${declaration.adresse}</td>
										<td>${declaration.created_at}</td>
										
										<td>
										<div><button class="btn btn-xs btn-danger" type="button" onclick="javascript:deleteDeclaration (${declaration.id})">Supprimer</button></div>
										<br><div><button class="btn btn-xs btn-success" type="button" >Details utilisateurs</button></div>
...
<script >
    ...
    function deletePolicier(id){
    	if (confirm("Etes vous sûr de vouloir supprimer cet declaration?")){
