...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <ul class="nav navbar-right top-nav">
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"><c:out value="${agent.email_agent}" /> </i><b class="caret"></b></a>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                           <img src="resources/icones/policeman.png"> Liste des policiers
                        </h1>
                        <ol class="breadcrumb">
                            <li>
                            ...
                            <li class="active">
                                <i class="fa fa-table"></i> Liste des policiers
                            </li>
                        </ol>
                    </div>
                </div>
             <a href="ModifierPolicier.html"><button class="btn btn-success" type="submit">Ajouter</button> </a><br> <br>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover table-striped">
                                ...
                                <tbody>
                                <c:forEach items="${policiers}" var="policier">
                                    <tr>
                                        <td>${policier.nom}</td>
                                        <td>${policier.cin}</td>
                                        <td>${policier.specialite}</td>
                                        <td>
										<button class="btn btn-xs btn-danger" type="button" onclick="javascript:deletePolicier (${policier.id})">Supprimer</button>
										<button class="btn btn-xs btn-info" type="button" onclick="window.location.href='editPolicier.html?id=${policier.id}'">Modifier</button>
										</td>
    ...
    function deletePolicier(id){
    	if (confirm("Etes vous sûr de vouloir supprimer cet policier?")){
    		window.location.href='deletePolicier.html?id='+id;
    	}
    }
    </script>
