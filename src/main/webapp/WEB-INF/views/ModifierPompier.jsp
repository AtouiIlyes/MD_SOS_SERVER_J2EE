                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                          <img src="resources/icones/pompier.png">  Modification pompier
                        </h1>
                        <ol class="breadcrumb">
                            <li>
                            ...
                            <li class="active">
                                <i class="fa fa-table"></i> Modification pompier
                            </li>
                        </ol>
                    </div>
                </div>
				...
				<div class="col-sm-4">
                        <div class="panel  panel-yellow">
                            <div class="panel-heading">
                                <h3 class="panel-title">Modifier pompier</h3>
	                            </div>
	                  <!--           
	                <c:if test="${pompier.id==0}">
						<c:set var="method" value="insertPompier.html"></c:set>
					     </c:if>
					<c:if test="${policier.id!=0}">
						<c:set var="method" value="updatePompier.html"></c:set>
					     </c:if>
	                           -->  
 							<f:form action="updatePompier.html" methode="post"  modelAttribute="pompier" >
 							<fieldset>
 							<input type="hidden" name="id" value="${pompier.id}" >
                            <div class="panel-body">
                            <div class="form-group input-group">
                                <span class="input-group-addon">nom</span>
                                <input type="text" name="nom" value="${pompier.nom}" class="form-control" placeholder="Username" required>
                            </div>
							<div class="form-group input-group">
                                <span class="input-group-addon">mot de passe</span>
                                <input type="text" name="password" value="${pompier.password}" class="form-control" placeholder="password" required>
							</div>
							<div class="form-group input-group">
                                <span class="input-group-addon">cin</span>
                                <input type="text" name="cin" value="${pompier.cin}" class="form-control" placeholder="Carte d'identité" required>
                            </div>
							<div class="form-group input-group">
                                <span class="input-group-addon">specialite</span>
                                <input type="text" name="specialite" value="${pompier.specialite}" class="form-control" placeholder="specialite" required>
                            </div>
