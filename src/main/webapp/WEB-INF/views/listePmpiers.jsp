...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                           <img src="resources/icones/pompier.png"> Liste des pompiers 
                        </h1>
                        <ol class="breadcrumb">
                            <li>
                            ...
                            <li class="active">
                                <i class="fa fa-table"></i> Liste des pompiers
                            </li>
                        </ol>
                    </div>
                </div>
               ...
               <div>
            <!-- /.container-fluid -->
				 <a href="ModifierPompier.html"><button class="btn btn-success" type="submit">Ajouter</button> </a><br> <br>
				</div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover table-striped">
                                ...
                                <tbody>
                                 ...
                                 <c:forEach items="${pompiers}" var="pompier">
                                    <tr>
                                        <td>${pompier.nom}</td>
                                        <td>${pompier.cin}</td>
                                        <td>${pompier.specialite}</td>
                                        <td>
										<button class="btn btn-xs btn-danger" type="button" onclick="javascript:deletePompier (${pompier.id})">Supprimer</button>
										<button class="btn btn-xs btn-info" type="button" onclick="window.location.href='editPompier.html?id=${pompier.id}'">Modifier</button>
										</td>
    ...
    function deletePompier(id){
    	if (confirm("Etes vous sûr de vouloir supprimer cet pompier?")){
    		window.location.href='deletePompier.html?id='+id;
    	}
    }
    </script>
